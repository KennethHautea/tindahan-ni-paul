...
<body onload="myFunction()" style="margin:0;">
    ...
    <div class="sidebar">
        ...
        <a class="active" href="delivery.php">Delivery</a>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="container" >
                ...
                <a href="#add" data-toggle="modal"><button type='button' class='btn btn-success btn-sm'><span class='glyphicon glyphicon-plus' aria-hidden='true'></span> Add Delivery</button>
                </a>
        <br>
        <br>
                        ...
                        <form method="post" class="form-horizontal" role="form">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title">Update Delivery Item</h4>
                                    </div>
                                    <div class="modal-body">
                                        <input type="hidden" name="edit_item_id" value="<?php echo $sup_Id; ?>">
                                        <div class="form-group">
                                            <label class="control-label col-sm-2" for="sup_Name">Date:</label>
                                            <div class="col-sm-4">
                                                <input type="Date" class="form-control" id="sup_Name" name="sup_Name" value="<?php echo $sup_Name; ?>" required autofocus>
                                            </div>
                                            <label class="control-label col-sm-2" for="location">Order:</label>
                                            <div class="col-sm-4">
                            ...
                            <form method="post">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="alert alert-danger">Are you Sure you want Delete This DeliveryID?<strong>
                ...
                <form method="post" class="form-horizontal" role="form">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="sup_Name">Date</label>
                            <div class="col-sm-4">
                                <input type="Date" class="form-control" id="sup_Name" name="sup_Name" autocomplete="off" autofocus required>
                            </div>
                            <label class="control-label col-sm-2" for="location">Order:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="location" name="location" placeholder="Location" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
